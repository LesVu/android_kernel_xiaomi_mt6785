...
__weak void aed_md_exception_api(const int *log, int log_size, const int *phy,
                                 int phy_size, const char *detail,
                                 const int db_opt) {}
EXPORT_SYMBOL(aed_md_exception_api);

__weak void aed_md32_exception_api(const int *log, int log_size, const int *phy,
                                   int phy_size, const char *detail,
                                   const int db_opt) {}
EXPORT_SYMBOL(aed_md32_exception_api);

__weak void aed_scp_exception_api(const int *log, int log_size, const int *phy,
                                  int phy_size, const char *detail,
                                  const int db_opt) {}
...
__weak int aee_is_printk_too_much(const char *module) { return 0; }
...
__weak int aee_nested_printf(const char *fmt, ...) { return 0; }

__weak int aee_in_nested_panic(void) { return 0; }
...
__weak void ipanic_recursive_ke(struct pt_regs *regs, struct pt_regs *excp_regs,
                                int cpu) {}
...
__weak int mtk_rgu_status_is_sysrst(void) { return 0; }

__weak int mtk_rgu_status_is_eintrst(void) { return 0; }
